...
(defun my-outline-minor-mode ()
  ...
  (when (and (seq-some #'local-variable-p '(outline-search-function outline-regexp))
    ...
    (setq-local outline-minor-mode-highlight
...
#+begin_src emacs-lisp
(when (let ((warning-inhibit-types '((files missing-lexbind-cookie))))
        (require 'ee-autoloads nil t))
...
(when (treesit-available-p)
  ...
  (when (and (treesit-ready-p 'javascript t) (not (treesit-ready-p 'json t)))
