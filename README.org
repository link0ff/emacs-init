...
Also by default most buffers pop up in the same window,
...
Make tab names as short as possible (from [[https://www.gnu.org/software/emacs/manual/html_node/gnus/#Tabbed-Interface][the Gnus manual]]):
