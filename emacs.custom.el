...
(custom-set-variables
 ...
 '(dired-listing-switches "-Alv --group-directories-first --block-size='1")
 ...
 '(display-buffer-alist
   '((display-buffer-to-xref-p display-buffer-maybe-below-selected)
     ...
     ("\\`\\*\\(Apropos\\|Buffer List\\|Colors\\|Command History\\|Locate\\|Messages\\|Proced\\|eww\\|snd\\|gud-[a-z0-9]+\\|vc-log\\)\\*\\'" display-buffer-same-window)
...
(custom-set-faces
 ...
 '(widget-button ((t nil)))
 '(xref-file-header ((t (:inherit success :background "grey95" :extend t))))
