...
(custom-set-variables
 ...
 '(kill-ring-max 1024)
 '(kill-whole-line t)
 '(large-file-warning-threshold 96000000)
 ...
 '(vc-dir-show-outgoing-count nil)
...
(custom-set-faces
 ...
 '(elisp-binding-variable ((t nil)))
 '(elisp-bound-variable ((t (:inherit font-lock-variable-use-face :foreground "black"))))
 '(elisp-free-variable ((t (:inherit font-lock-variable-use-face :foreground "black" :weight bold))))
 '(elisp-function ((t nil)))
 '(elisp-shorthand-font-lock-face ((t (:inherit shadow))))
