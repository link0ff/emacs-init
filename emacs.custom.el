...
(custom-set-faces
 ...
 '(diff-indicator-added ((t (:inherit diff-added :foreground "#22aa22"))))
 '(diff-indicator-changed ((t (:inherit diff-changed :foreground "#aaaa22"))))
 '(diff-indicator-removed ((t (:inherit diff-removed :foreground "#aa2222"))))
